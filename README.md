...
Elixir is a simple and fun bot that does simple sentimental analysis on speech and text.
It was developed with streamlit for the ui and groq api for the LLM.
It has 2 input modes : Speech and text.
